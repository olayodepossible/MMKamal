...
--
-- Name: mmkamal; Type: EXTENSION; Schema: -; Owner:
--

CREATE EXTENSION IF NOT EXISTS mmkamal WITH SCHEMA pg_catalog;


--
-- Name: EXTENSION mmkamal; Type: COMMENT; Schema: -; Owner:
--

COMMENT ON EXTENSION mmkamal IS 'PL/pgSQL procedural language';
